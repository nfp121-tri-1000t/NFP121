...
public class AuditeurCNAM {
    ...
    public String login() {
        ...
        if(lognom.length()>6) {
         ...
         loginshort = loginshort.replaceAll("[èéêë]","e");
          loginshort = loginshort.replaceAll("[ûù]","u");
           loginshort = loginshort.replaceAll("[ïî]","i");
            loginshort = loginshort.replaceAll("[àâ]","a");
            loginshort = loginshort.replaceAll("Ô","o");
            
            
       
            
        return loginshort ;// à compléter
    }
