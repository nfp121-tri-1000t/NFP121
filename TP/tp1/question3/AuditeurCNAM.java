...
public class AuditeurCNAM {
    ...
    public String login() {
        String lognom = nom();
         ...
         lognom = lognom.replaceAll("[èéêë]","e");
          lognom = lognom.replaceAll("[ûù]","u");
           lognom = lognom.replaceAll("[ïî]","i");
            lognom = lognom.replaceAll("[àâ]","a");
            lognom = lognom.replaceAll("Ô","o");
        ...
        String logprenom = prenom().toLowerCase() ;
               logprenom = logprenom.replaceAll("[èéêë]","e");
          logprenom = logprenom.replaceAll("[ûù]","u");
           logprenom = logprenom.replaceAll("[ïî]","i");
            logprenom = logprenom.replaceAll("[àâ]","a");
            logprenom = logprenom.replaceAll("Ô","o");
            logprenom = logprenom.substring(0,1);
            
        return lognom + "_" + logprenom ;// à compléter
    }
